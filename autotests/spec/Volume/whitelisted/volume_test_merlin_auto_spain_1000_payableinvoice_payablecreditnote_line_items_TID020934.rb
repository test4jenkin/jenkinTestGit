...
describe "TID020934 : PIN / PCR document limits - VAT company(CIF)", :type => :request do
	...
	_pin_description = 'Updated Payable Invoice'
	_pcn_description = 'Updated Payable Credit Note'
	...
	it "TST035514 | TST035515 : Verify EDIT and SAVE | POST functionality on PINV with 1000 lines" do 
		...
		begin
			...
			CIF_PINV.set_pinv_invoice_description _pin_description
			...
			gen_compare _pin_description,  CIF_PINV.get_payable_invoice_description, "Expected PIN description should be #{_pin_description}"
	...
	it "TST035516 : Verify SAVE & POST functionality on PINV | POST & MATCH functionality on PCRN with 1000 lines" do
        login_user
		begin
			...
			gen_start_test "TST035516: Verify Post & Match functionality on PCRN with 1000 lines"
			CIF.click_convert_to_credit_note_button
			PCR.set_vendor_credit_note_number_convert "PCN000003"
			...
			gen_wait_until_object $cif_continue_button_on_info_message_popup
			CIF.click_continue_button
			SF.wait_for_search_button
			
			gen_compare $bd_document_status_complete,  CIF_PCN.get_payable_credit_note_status, "Expected PCRN should be with Complete status"
			gen_end_test "TST035516: Verify Post & Match functionality on PCRN with 1000 lines"
		end
		SF.logout
	end
	...
	it "TST035536 | TST035537 : Verify EDIT and SAVE | POST functionality on PCRN with 1000 lines" do 
		...
		begin
			...
			CIF.click_edit_button
			CIF_PCN.set_pcn_description _pcn_description
			CIF_PCN.click_payable_credit_note_line_items_tab
			...
			gen_compare _pcn_description,  CIF_PCN.get_payable_credit_note_description, "Expected PCN description should be #{_pcn_description}"
