#--------------------------------------------------------------------#
#	TID : TID010944
# 	Test Step ID: TST013182 and TST013183
# 	Pre-Requisite : org with base data and deploy CODATID010944Data.cls 
#  	Product Area: Merlin Auto Spain- Create and Post SIN with 42 line items and Income schedule.
# 	Story:#26576
#--------------------------------------------------------------------#

describe "Volume Test:Merlin Auto Spain- Create and Post SIN with 42 line items and Income schedule.", :type => :request do
	...
	before :all do
		#Hold Base Data
		gen_start_test "TID010944 - TST013182 and TST013183 , Create Sales Invoices with 42 line items and Income schedule for Merlin Auto Spain."
	...
	it "Create Sales Invoices with 42 line items and Income schedule." do
		...
		begin			
			create_sales_invoices = [ "CODATID010944Data.selectcompany();",
			"CODATID010944Data.createdata();",
			"CODATID010944Data.createdataext1();",
			"CODATID010944Data.createdataext2();",
			"CODATID010944Data.createdataext3();",
			"CODATID010944Data.createdataext4();"]				
		...
		begin
			...
			while count <= 2			
				...
				if count == 1 then 	
					puts "#TST013182 - Save 42 line Items and  Post."
					SF.click_button_save
					SF.wait_for_search_button
					FFA.click_post
					SF.wait_for_search_button					
				else
					puts "#TST013183-Save & Post 42 line items."
					FFA.click_save_post
					SF.wait_for_search_button
				end	
	...
	after :all do
		#delete Test Data
		login_user		
		delete_data = [ "CODATID010944Data.destroyData();"]
		...
		gen_end_test "TID010944 - TST013182 and TST013183 , Create Sales Invoices with 42 line items and Income schedule for Merlin Auto Spain."
	end
end
