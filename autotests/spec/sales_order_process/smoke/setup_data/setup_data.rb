#--------------------------------------------------------------------#
#	TID : TID005984 Sales Order Processing Setup Prerequistic
# 	Pre-Requisite :Install latest versions of following packages on Org in same order
#				  # ERP, FFA , FFR, Sales Order Processing package deploy basedata
#  	Product Area: Accounting - others- Sales Order Processing
#--------------------------------------------------------------------#
describe "Smoke Test - Sales Order Processing", :type => :request do
